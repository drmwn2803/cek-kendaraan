        ...
        <tr>
            ...
            <td>
                <form action="" method="post">
                    <button type="button" class="btn btn-sm btn-warning text-light" data-toggle="modal"
                        data-target="#modal-edit<?= $row->id; ?>">
                        <i class="fas fa-edit"></i>
                    </button>

                    <input type="hidden" name="id_dusun" value="<?= $row->id; ?>">
                    <button type="submit" name="hapus_dusun" class="btn btn-sm btn-danger"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Form Edit Status</h4>
