                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img border-0 img-fluid"
                                src="<?= $base_url; ?>dist/img/<?= $row_profil->logo_desa; ?>"
                        ...
                        <ul class="list-group list-group-unbordered mt-3">
                            ...
                            <li class="list-group-item">
                                <b>Maps</b>
                                <iframe src="<?= $row_profil->maps; ?>" class="mt-3" width="100%" height="200"
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-1">Seluruh Status Progress</h3>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah Status</h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama_desa">Nama PT</label>
                        <input type="text" name="nama_desa" id="nama_desa" class="form-control"
                            value="<?= $row_profil->nama_desa; ?>">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="text" name="email" id="email" class="form-control"
                            value="<?= $row_profil->email; ?>">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea name="alamat" id="alamat" rows="2"
                            class="form-control"><?= $row_profil->alamat; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="maps">Maps</label>
                        <textarea name="maps" id="maps" rows="3"
                            class="form-control"><?= $row_profil->maps; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="logo">Logo PT</label>
